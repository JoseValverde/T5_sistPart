class AudioManager {
  ...
  void update() {
    ...
    // Calcular niveles por rangos de frecuencia
    nivelGraves = calcularNivelEnRango(0, bandas/6);
    nivelMedios = calcularNivelEnRango(bandas/6, bandas/2);
    nivelAgudos = calcularNivelEnRango(bandas/2, bandas-1);
  }
